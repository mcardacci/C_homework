...
int main(int argc, char *argv[]) 
{
    ...
    printf("\t[+] allocating %d bytes of memeory on the heap for char_ptr\n", mem_size);
    ...
    *int_ptr = 31337;  // Put the value of 31337 where int_ptr is pointing.
    ...
    free(char_ptr);  // Freeing char_ptr's heap memory

    printf("[+] allocating another 15 bytes for char_ptr\n");
    char_ptr = (char *) malloc(20);  // Allocating more heap memory
